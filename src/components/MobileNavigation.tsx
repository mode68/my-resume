...
import { StyledMobileNavigationContainer, StyledMobileNavBar } from '../shared/styled/MobileNavigationComponents';
...
const MobileNavigation: React.FC = ({ children }) => {
	...
	return (
		<StyledMobileNavigationContainer>
			...
			{shouldRenderChild && (
				<>
					<StyledMobileNavBar onClick={handleMenuButtonClick} show={toggleMenu}>
						{children}
					</StyledMobileNavBar>
