...
const Skills = () => {
    const skills = [{ name: 'JavaScript', rating: 5 }, { name: 'HTML', rating: 5 }, { name: 'JSON', rating: 5 }, { name: 'XML', rating: 5 }, { name: 'CSS', rating: 4 }, { name: 'React', rating: 4 }, { name: 'Object Orientated Programming', rating: 4 }, { name: 'Git', rating: 3 }];
    const skills2 = [{ name: 'Node.js', rating: 3 }, { name: 'Scrum', rating: 3 }, { name: 'MongoDB', rating: 2 }, { name: 'TypeScript', rating: 2 }, { name: 'Express', rating: 1 }, { name: 'Java', rating: 1 }, { name: '.NET', rating: 1 }];
    const languages = [{ name: 'Lithuanian (mother tongue)', rating: 5 }, { name: 'English (daily use)', rating: 5 }, { name: 'Japanese (survivable)', rating: 2}];
    return (
